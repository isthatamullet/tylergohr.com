...
- main:
  ...
  - region "Ready to transform your technical challenges?":
    ...
    - alert:
      - heading "Message Failed to Send" [level=4]
      - paragraph: Sorry, there was an issue sending your message. Please try again or email me directly.
    - text: Name *
    ...
    - text: Message *
    - textbox "Message *": This is a test message for network error handling.
    - button "Send Message"
    - paragraph
