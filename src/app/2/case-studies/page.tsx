...
const caseStudies: CaseStudy[] = [
  {
    ...
    challenge: 'Fox Corporation needed to revolutionize their content strategy for their largest direct-to-consumer video product, managing over 50,000+ titles while ensuring high-quality, engaging content across diverse platforms. The existing system was inefficient, costly, and couldn{"'"}t scale with their growing streaming ambitions.',
    ...
    results: [
      ...
      'Quality Excellence: Achieved industry-leading content standards across 50,000+ titles'
    ],
