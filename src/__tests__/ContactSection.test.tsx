...
describe("ContactSection", () => {
  ...
  it("displays subject options correctly", () => {
    ...
    expect(
      screen.getByRole("option", { name: "Select a subject" }),
    ).toBeInTheDocument();

    // Check all subject options
    expect(
      screen.getByRole("option", { name: "New Project Inquiry" }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("option", { name: "Collaboration Opportunity" }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("option", { name: "Technical Discussion" }),
    ).toBeInTheDocument();
  ...
  it("renders contact information links", () => {
    ...
    const githubLink = screen.getByRole("link", {
      name: /Visit Tyler's GitHub profile/,
    });
    ...
    const linkedinLink = screen.getByRole("link", {
      name: /Connect with Tyler on LinkedIn/,
    });
    expect(linkedinLink).toHaveAttribute(
      "href",
      "https://linkedin.com/in/tyler-gohr",
    );
  ...
  it("displays expectation information", () => {
    ...
    expect(
      screen.getByText("Technical solutions-oriented"),
    ).toBeInTheDocument();
